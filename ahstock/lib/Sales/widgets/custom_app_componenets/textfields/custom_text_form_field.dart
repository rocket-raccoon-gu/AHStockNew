    ...
    switch (widget.validator) {
      ...
      case Validator.minimumDecimalValueLimit:
        error = minimumDecimalValueValidation(
            value, widget.minimumDecimalValueLimit);
        break;
      ...
      default:
        error = emptyValidation(
            widget.controller.value.toString(), widget.defaultErrorMessage);
    }
    if (error != null) {
      showSnackBar(
          context: context, snackBar: showErrorDialogue1(errorMessage: error));
